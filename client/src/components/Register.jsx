...
//////////////////////// SOURCE CODE VERSION 2.0  (READY FOR DEVELOPMENT) ////////////////////////
// CODE CLEANED LAST ON : 27-02-2025
// CODE LENGTH OF FILE SIGNUPFORM.JSX LINE 16 - LINE 710 (approx)
...
function SignupForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
        const response = await fetch('https://servicenow-1-rcpd.onrender.com/auth/signup', {
        method: "POST",
        headers: {
